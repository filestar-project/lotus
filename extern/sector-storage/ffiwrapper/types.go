...
type SectorProvider interface {
	...
	AcquireSector(ctx context.Context, id storage.SectorRef, existing storiface.SectorFileType, allocate storiface.SectorFileType, ptype storiface.PathType, _ bool) (storiface.SectorPaths, func(), error)
}
