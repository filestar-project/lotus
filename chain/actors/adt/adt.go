...
func AsMap(store Store, root cid.Cid, version actors.Version, bitwidth int) (Map, error) {
	switch version {
	...
	case actors.Version3:
		return adt3.AsMap(store, root, bitwidth)
	}
...
func NewMap(store Store, version actors.Version, bitwidth int) (Map, error) {
	...
	case actors.Version3:
		return adt3.MakeEmptyMap(store, bitwidth)
	}
	return nil, xerrors.Errorf("unknown network version: %d", version)
}
