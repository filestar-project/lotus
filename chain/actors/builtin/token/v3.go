...
func (s *state3) GetInfo() (*TokenStateInfo, error) {
	return &TokenStateInfo{
		Nonce: s.State.Nonce,
	}, nil
}

func (s *state3) TokenCreators() ([]addr.Address, error) {
...
func (s *state3) TokenCreatorByTokenID(tokenID big.Int) (addr.Address, error) {
	var tokenCreator addr.Address
...
func (s *state3) TokenIDsByCreators(creator addr.Address) ([]big.Int, error) {
...
func (s *state3) TokenURIByTokenID(tokenID big.Int) (string, error) {
	if tokenID.Nil() || tokenID.LessThanEqual(big.Zero()) || tokenID.GreaterThan(s.State.Nonce) {
...
func (s *state3) TokenBalanceByTokenID(tokenID big.Int) ([]*TokenBalanceInfoByTokenID, error) {
...
func (s *state3) TokenBalanceByAddr(owner addr.Address) ([]*TokenBalanceInfoByAddr, error) {
...
func (s *state3) TokenBalanceByTokenIDAndAddr(tokenID big.Int, owner addr.Address) (abi.TokenAmount, error) {
	if tokenID.Nil() || tokenID.LessThanEqual(big.Zero()) || tokenID.GreaterThan(s.State.Nonce) {
...
func (s *state3) TokenBalanceByTokenIDsAndAddrs(tokenIDs []big.Int, owners []addr.Address) ([]abi.TokenAmount, error) {
...
func (s *state3) TokenIsAllApproved(addrFrom addr.Address, addrTo addr.Address) (bool, error) {
