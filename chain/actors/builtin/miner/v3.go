...
func (s *state3) LoadVestingFunds() (*VestingFunds, error) {
...
func (s *state3) GetSectorExpiration(num abi.SectorNumber) (*SectorExpiration, error) {
	...
	// 3. If it's faulty, it will expire early within the first 14 entries
...
func (d *deadline3) PostSubmissions() (bitfield.BitField, error) {
